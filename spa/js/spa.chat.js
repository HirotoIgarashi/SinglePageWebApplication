...
spa.chat = (function () {
  ...
  setSliderPosition = function ( position_type, callback ) {
    ...
    // スライダーがすでに要求された位置にある場合にはtrueを返す
  ...
  //  * slider_*構成。 すべてのオプションのスカラー。完全なリストはmapConfig.settable_mapを参照。
  ...
  // 目的:
  //  ウィンドウリサイズイベントに対し、必要に応じてこのモジュールが
  //  提供する表示を調整する
  // 動作:
  //  ウィンドウの高さや幅が所定の閾値を下回ったら、
  //  縮小したウィンドウサイズに合わせてチャットスライダーのサイズを
  //  変更する。
  // 戻り値: プール値
  //  * false - リサイズを考慮していない
  //  * true  - リサイズを考慮した
